...
$(PROJECT_NAME).$(LNK_SUFFIX): Makefile \
   ...
   $(ECHO) "MEMORY"                                                                                     >> $@; \
   $(ECHO) "{"                                                                                          >> $@; \
   $(ECHO) "   /* Flash driver area */"                                                                 >> $@; \
   $(ECHO) "   SIGN    (RW)   :  origin=0x08001000   length=0x14"                                       >> $@; \
   $(ECHO) "   ALL     (RW)   :  origin=0x08001015   length=0x17EA"                                     >> $@; \
   $(ECHO) "   FLSRAM  (RW)   :  origin=0x08002800   length=0x0400"                                     >> $@; \
   $(ECHO) "   STACK   (RW)   :  origin=0x08002C00   length=0x0400"                                     >> $@; \
   $(ECHO) "}"                                                                                          >> $@; \
   $(ECHO) "/****************************************************************************************/" >> $@; \
   $(ECHO) ""                                                                                           >> $@; \
   $(ECHO) ""                                                                                           >> $@; \
   ...
   $(ECHO) "SECTIONS"                                                                                   >> $@; \
   $(ECHO) "{"                                                                                          >> $@; \
   $(ECHO) "   .SIGNATURE     : {} > SIGN /* The code starts with the signature         */"             >> $@; \
   $(ECHO) "   .text          : {} > ALL  /* CODE                                       */"             >> $@; \
   $(ECHO) "   .bss           : {} > FLSRAM"                                                            >> $@; \
   $(ECHO) "   .data          : {} > ALL"                                                               >> $@; \
   $(ECHO) "   .const         : {} > FLSRAM"                                                            >> $@; \
