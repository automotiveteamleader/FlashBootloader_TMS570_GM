...
struct tagCanInitTable
{
   ...
   vuint8 TpTxIdLow;
#  if defined( V_CPU_VYBRID ) /* This V_CPU switch shall be used as long as there is no other CAN cell than the FLEXCAN3 available for the MCU VYBRID */
   vuint16 CanInitCtrl01;            /**< Control register 0 */
   vuint16 CanInitCtrlPr2;           /**< Control register 1 */
#  else
   vuint16 CanInitBT0;
   vuint16 CanInitBT1;
#  endif
